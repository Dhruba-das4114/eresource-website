...
// Fetch subjects for Subject 22 page (Adjust IDs as per database)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (22, 23)"; // Adjust subject IDs accordingly
...
<head>
    ...
    <link rel="stylesheet" href="sub22.css">
</head>
<body>
