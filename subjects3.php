...
// Fetch subjects for Subject 3 page (IDs 5, 6, 7, 8 assumed for Data Structure, OS, CN, and OSS)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (5, 6, 7, 8)";
