...
// Fetch subjects for Subject 33 page (Adjust IDs as per database)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (24, 25, 26, 27)"; // Adjust subject IDs accordingly
...
<head>
    ...
    <link rel="stylesheet" href="sub33.css">
</head>
<body>
