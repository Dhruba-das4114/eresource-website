...
// Fetch subjects for Subject 4 page (IDs assumed for DAA, CG, DBMS, and Python)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (9, 10, 11, 12)"; // Adjust IDs as per database
