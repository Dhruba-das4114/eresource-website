...
// Fetch subjects for Subject 44 page (Adjust IDs as per database)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (28, 29, 30, 31)"; // Adjust subject IDs accordingly
...
<head>
    ...
    <link rel="stylesheet" href="sub44.css">
</head>
<body>
