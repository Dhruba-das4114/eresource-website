...
// Fetch subjects for Subject 5 page (IDs assumed for Java, MIS, NSM, and IT)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (13, 14, 15, 16)"; // Adjust IDs as per database
