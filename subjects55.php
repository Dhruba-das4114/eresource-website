...
// Fetch subjects for Subject 55 page (Adjust IDs as per database)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (32, 33, 34, 35)"; // Adjust subject IDs accordingly
...
<head>
    ...
    <link rel="stylesheet" href="sub55.css">
</head>
<body>
