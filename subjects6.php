...
// Fetch subjects for Subject 6 page (IDs assumed for E-Commerce, Software Engineering, PHP, and Project Work)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (17, 18, 19,44)"; // Adjust IDs as per database
