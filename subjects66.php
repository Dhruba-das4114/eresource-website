...
// Fetch subjects for Subject 66 page (Adjust IDs as per database)
$sql_subjects = "SELECT * FROM subjects WHERE id IN (36, 37, 38, 39)"; // Adjust subject IDs accordingly
...
<head>
    ...
    <link rel="stylesheet" href="sub66.css">
</head>
<body>
